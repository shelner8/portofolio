...
export const metadata = {
  title: 'Beszel | Technology Library',
  description: 'Beszel provides lightweight, real-time resource monitoring for individual Docker containers and Linux hosts.',
}
          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>Beszel is used for lightweight resource monitoring of Docker containers and Linux hosts.</p>
                <p>It acts as a simple dashboard for assessing CPU, memory, and disk usage across the infrastructure.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed">
                <p>Beszel is deployed to track granular container metrics with minimal overhead.</p>
                <p>It is used for quick identification of resource-heavy applications to ensure host systems operate within capacity.</p>
              </div>
            </div>
