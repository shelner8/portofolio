          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>Portainer is used as the web management interface for Docker administration across the home lab.</p>
                <p>It is deployed to monitor containers and manage lifecycles for images, volumes, stacks, and networks.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed">
                <p>Portainer runs as a containerized service to monitor container health and execute administrative tasks without requiring terminal access.</p>
                <p>It acts as the central interface for interacting with local Docker hosts and managing the self-hosted stack.</p>
              </div>
            </div>
