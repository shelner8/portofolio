...
export const metadata = {
  title: 'VMware ESXi | Technology Library',
  description: 'VMware ESXi is deployed to maintain operational familiarity with enterprise hypervisor architectures.',
}

export default function TechnologyPage() {
  const useCases = [
    "Virtual appliance deployment",
    "Enterprise hypervisor validation",
    "Network adapter passthrough testing",
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-8 md:gap-10">
              ...
              <DeploymentEvidence 
                ...
                caption="Self-hosted VMware ESXi instance deployed in the home lab environment for enterprise network emulation and pre-production validation."
              />
