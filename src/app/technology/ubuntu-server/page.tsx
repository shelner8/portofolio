...
export const metadata = {
  title: 'Ubuntu Server | Technology Library',
  description: 'Ubuntu Server functions as the core operating system for all self-hosted containerized applications and utility scripts.',
}
...
export default function TechnologyPage() {
  const useCases = [
    ...
    "Syslog and metrics aggregation",
          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>Ubuntu Server functions as the core operating system for all self-hosted containerized applications and utility scripts.</p>
                <p>It provides a stable, predictable Linux environment for automation execution, monitoring agents, and infrastructure management.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed">
                ...
                <p>They serve as dedicated hosts for Docker Swarm/Compose stacks, reverse proxies, and continuous integration runners.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8 md:gap-10">
              ...
              <DeploymentEvidence 
                ...
                caption="Self-hosted Ubuntu Server instance deployed in the home lab environment for enterprise network emulation and pre-production validation."
              />
