...
export const metadata = {
  title: 'Site-to-Site VPN | Technology Library',
  description: 'Site-to-Site VPN tunnels securely interconnect the home lab with external cloud environments and secondary locations.',
}

export default function TechnologyPage() {
  const useCases = [
    "Cross-site encrypted routing",
    "Cloud infrastructure bridging",
    "Remote backup replication",
    "Dynamic routing over IPsec",
    "Enterprise WAN simulation",
    "Secure subnet interconnection"
];
          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>Site-to-Site VPN tunnels securely interconnect the home lab with external cloud environments and secondary locations.</p>
                <p>They ensure continuous, encrypted routing for cross-site backups and distributed applications.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed">
                <p>These VPN tunnels are established using IPsec or WireGuard directly on the edge routing hardware.</p>
                <p>The deployment simulates enterprise WAN connectivity, allowing for dynamic routing protocols to operate across encrypted geographical boundaries.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8 md:gap-10">
              ...
              <DeploymentEvidence 
                ...
                subtitle="Current self-hosted Site-to-Site VPN deployment running inside the Home Lab."
                imagePath="/images/homelab/site-to-site-vpn-dashboard.png"
                altText="Site-to-Site VPN Dashboard"
                caption="Self-hosted Site-to-Site VPN instance deployed in the home lab environment for enterprise network emulation and pre-production validation."
              />
