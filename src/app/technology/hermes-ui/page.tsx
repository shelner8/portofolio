...
export const metadata = {
  title: 'Hermes UI | Technology Library',
  description: 'Hermes UI acts as the primary graphical interface for interacting with self-hosted language models.',
}
          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>Hermes UI is used as the graphical interface for interacting with various AI models.</p>
                <p>It acts as a conversational frontend for testing prompts, managing context, and retaining conversation history.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed">
                <p>Hermes UI connects directly to the 9Router endpoint to facilitate interaction with different AI providers.</p>
                <p>It is deployed via Docker to act as a practical interface for evaluating model responses and managing prompt templates.</p>
              </div>
            </div>
