...
export const metadata = {
  title: 'Agent DVR CCTV | Technology Library',
  description: 'Agent DVR manages continuous video surveillance and IP camera recording for the physical environment.',
}
          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>Agent DVR manages continuous video surveillance and IP camera recording for the physical environment.</p>
                <p>It processes video streams locally, ensuring physical security data never leaves the internal network.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed">
                <p>The platform aggregates multiple IP camera feeds into a single monitoring interface.</p>
                <p>It handles motion detection, storage retention policies, and alert generation completely offline.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8 md:gap-10">
              ...
              <DeploymentEvidence 
                ...
                caption="Self-hosted Agent DVR CCTV instance deployed in the home lab environment for enterprise network emulation and pre-production validation."
              />
