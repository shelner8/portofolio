          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>Agent DVR manages video surveillance and IP camera recording for the local environment.</p>
                <p>It processes video streams locally, ensuring physical security data remains on the internal network.</p>
              </div>
            </div>
          </div>
        </div>
