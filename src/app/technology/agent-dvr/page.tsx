          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>Agent DVR is used to manage video surveillance and IP camera recording for the local environment.</p>
                <p>It is deployed to process video streams locally, keeping physical security data on the internal network.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed">
                <p>Agent DVR runs locally to aggregate multiple IP camera feeds into a single monitoring interface.</p>
                <p>It is responsible for handling motion detection, storage retention policies, and alert generation completely offline.</p>
              </div>
            </div>
