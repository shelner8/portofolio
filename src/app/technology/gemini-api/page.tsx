...
export const metadata = {
  title: 'Gemini API | Technology Library',
  description: 'The Gemini API is integrated into internal workflows to assist with infrastructure documentation and script generation.',
}

export default function TechnologyPage() {
  const useCases = [
    "Automated documentation generation",
    "Complex configuration synthesis",
    "Log summarization",
    "Script drafting",
          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-xl md:text-2xl text-muted leading-relaxed font-light mt-4 flex flex-col gap-4">
                <p>The Gemini API is integrated into internal workflows to assist with infrastructure documentation and script generation.</p>
                <p>It supplements local models by handling complex reasoning tasks and generating structured configurations.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-16 md:gap-20 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-muted leading-relaxed">
                <p>The API is accessed through automated scripts to format network telemetry and summarize architectural changes.</p>
                <p>It provides a reliable external reasoning engine when local hardware constraints prevent running sufficiently large models.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8 md:gap-10">
              ...
              <DeploymentEvidence 
                ...
                subtitle="Current self-hosted Gemini API deployment running inside the Home Lab."
                imagePath="/images/homelab/gemini-api-dashboard.png"
                altText="Gemini API Dashboard"
                caption="Self-hosted Gemini API instance deployed in the home lab environment for enterprise network emulation and pre-production validation."
              />
