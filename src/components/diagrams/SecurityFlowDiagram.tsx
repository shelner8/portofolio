...
export function SecurityFlowDiagram() {
  return (
    <div className="w-full max-w-6xl mx-auto overflow-hidden rounded-2xl border border-surface bg-[#0a0f1c] shadow-2xl my-12">
      <div className="p-5 md:p-6 border-b border-surface/50 bg-[#0f172a] flex items-center">
        <h3 className="text-base md:text-lg font-bold text-primary font-mono flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-accent-blue animate-pulse shadow-[0_0_8px_#3b82f6]" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-surface/50">
        ...
        <div className="p-8 md:p-12 bg-[#0a0f1c] flex flex-col items-center">
          <div className="mb-8 text-center flex flex-col items-center">
            <span className="text-lg md:text-xl font-bold text-primary font-mono tracking-widest">EAST - WEST</span>
            <span className="text-sm text-muted mt-1 font-mono">Internal Workload Inspection</span>
            <div className="w-16 h-px bg-surface-light mt-4" />
          </div>
        ...
        <div className="p-8 md:p-12 bg-[#0a0f1c] flex flex-col items-center">
          <div className="mb-8 text-center flex flex-col items-center">
            ...
            <span className="text-sm text-muted mt-1 font-mono">External Perimeter Defense</span>
            <div className="w-16 h-px bg-surface-light mt-4" />
          </div>
