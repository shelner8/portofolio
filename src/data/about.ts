...
export const about: About = {
  ...
  bio: [
    ...
    "Successful infrastructure requires careful planning, validation, documentation, and continuous improvement. My approach combines operational experience with hands-on implementation to deliver reliable, maintainable, and scalable network solutions."
  ],
